// GET/POST /.netlify/functions/job-run-status?runId=...  (auth required)  — Sub-brick 2b
//
// ⚠️ THERE IS NO `/api/` ROUTE FOR THIS FUNCTION — call `/.netlify/functions/job-run-status`.
